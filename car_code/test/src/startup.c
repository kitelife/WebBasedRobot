...
extern void GPIO_Port_A_ISR(void);    // GPIO A端口中断处理程序
extern void GPIO_Port_B_ISR(void);    // GPIO B端口中断处理程序
extern void GPIO_Port_H_ISR(void);    // GPIO H端口中断处理程序
extern void GPIO_Port_C_ISR(void);    // GPIO C端口中断处理程序
extern void GPIO_Port_D_ISR(void);    // GPIO D端口中断处理程序
extern void GPIO_Port_G_ISR(void);    // GPIO G端口中断处理程序
